...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "Eva Mariya;Arjuu;https://cdn.ironman.my.id/i/n5sz9g.png",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "Eva Mariya;Arjuu;https://cdn.ironman.my.id/i/n5sz9g.png",
	...
	STICKER_DATA: process.env.STICKER_DATA || `EVA-MARIYA`,
